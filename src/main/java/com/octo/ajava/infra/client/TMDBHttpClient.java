...
public class TMDBHttpClient {
    ...
    public TMDBHttpClient(
        ...
        /**
         * Construction d'un client HTTP spécifique à TMDB :
         *  - Ajout de l'authentification par token de TMDB
         *  - Ajout d'une configuration de timeout (pour ne pas surcharger le connexion pool)
