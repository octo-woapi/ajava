...
class TMDBFilmRepositoryTest {
  ...
  void recupererLesFilms_retourne_une_liste_de_films_TMDB() {
    ...
    // When
    List<Film> result = tmdbFilmRepository.recupererLesFilms();

    // Then
    assertThat(result).isEqualTo(deuxFilmsPopulaires());
  }
  ...
  void rechercherDesFilms_retourne_une_liste_de_films() {
    ...
    // When
    List<Film> result = tmdbFilmRepository.chercherDesFilms("batman");
