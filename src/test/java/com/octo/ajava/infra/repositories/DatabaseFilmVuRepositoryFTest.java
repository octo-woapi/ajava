  ...
  void modifierFilmVu() throws Exception {
    ...
    FilmVu filmVuExistant =
        databaseFilmVuRepository.ajouterUnFilmVu(
            new FilmVu(13, UTILISATEUR_ID, "08/10", "Le Parrain est cool !"));
    // TODO modifier la note et le commentaire

    // When
    FilmVu filmVuModifie = databaseFilmVuRepository.modifierUnFilmVu(null); // TODO

    // Then
    assertThat("TODO").isEqualTo(filmVuExistant.getId()); // TODO
    assertThat("TODO").isEqualTo(1);
