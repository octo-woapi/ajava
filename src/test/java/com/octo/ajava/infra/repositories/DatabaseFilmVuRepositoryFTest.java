...
class DatabaseFilmVuRepositoryFTest {
  ...
  void modifierFilmVu() throws Exception {
    ...
    // Then
    FilmVu filmVuTrouve = null; // TODO vérifier que la modification a bien été effectuée en BDD
    assertThat(filmVuTrouve).isEqualTo("5/10"); // TODO
    assertThat(filmVuTrouve).isEqualTo("Batman c'est moyen"); // TODO
  }
}
